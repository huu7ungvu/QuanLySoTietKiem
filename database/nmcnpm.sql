...
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK004','0004','LTK02','50000000',STR_TO_DATE('14-01-2022', '%d-%m-%Y'),STR_TO_DATE('14-04-2022', '%d-%m-%Y'),'0','0');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK005','0005','LTK03','150000000',STR_TO_DATE('17-04-2022', '%d-%m-%Y'),STR_TO_DATE('17-10-2022', '%d-%m-%Y'),'150000000','1');
...
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK007','0007','LTK02','350000000',STR_TO_DATE('17-07-2021', '%d-%m-%Y'),STR_TO_DATE('17-03-2021', '%d-%m-%Y'),'0','0');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK008','0008','LTK01','600000000',STR_TO_DATE('08-04-2022', '%d-%m-%Y'),STR_TO_DATE('09-10-2022', '%d-%m-%Y'),'400000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK009','0009','LTK03','100000000',STR_TO_DATE('06-04-2022', '%d-%m-%Y'),STR_TO_DATE('06-10-2022', '%d-%m-%Y'),'100000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK010','0010','LTK02','780000000',STR_TO_DATE('24-05-2022', '%d-%m-%Y'),STR_TO_DATE('24-08-2022', '%d-%m-%Y'),'100000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK011','0011','LTK03','100000000',STR_TO_DATE('01-04-2022', '%d-%m-%Y'),STR_TO_DATE('01-10-2022', '%d-%m-%Y'),'780000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK012','0012','LTK01','800000000',STR_TO_DATE('01-03-2022', '%d-%m-%Y'),STR_TO_DATE('06-10-2022', '%d-%m-%Y'),'500000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK013','0013','LTK02','130000000',STR_TO_DATE('05-01-2022', '%d-%m-%Y'),STR_TO_DATE('05-04-2022', '%d-%m-%Y'),'0','0');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK014','0001','LTK03','440000000',STR_TO_DATE('11-01-2022', '%d-%m-%Y'),STR_TO_DATE('11-07-2022', '%d-%m-%Y'),'440000000','1');
INSERT INTO Phieutietkiem (maptk,makh,maltk,sotiengoi,ngaymophieu,ngaydongphieu,sodu,tinhtrang) VALUES ('PTK015','0001','LTK02','550000000',STR_TO_DATE('23-04-2022', '%d-%m-%Y'),STR_TO_DATE('23-06-2022', '%d-%m-%Y'),'550000000','1');
...
INSERT INTO Phieuruttien (maprt,makh,maptk,ngayrut,sotienrut) VALUES ('PRT004','0007','PTK007',STR_TO_DATE('17-03-2021', '%d-%m-%Y'),'350000000');
